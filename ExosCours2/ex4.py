# Exercice 4 : passage d’une image couleur en négatif
# Implémentez un bouton "Négatif" qui créera le négatif de l'image. Pour cela soustrayez de 255 chaque
# composante de chaque pixel (ie faire le complément à 255 de chaque valeur). Cela inverse l'intensité de
# chaque couleur : le clair devient foncé et vice versa. Vous avez votre image en négatif !
...
def negatif():
    ...
    global matrice_G1
    global matrice_B1
    matrice_R1 = 255 - matrice_R
    matrice_G1 = 255 - matrice_G
    matrice_B1 = 255 - matrice_B
    mainLoop()
...
negatif_button = tk.Button(button_frame, text="Negatif", command=negatif)
negatif_button.config(foreground="black")
negatif_button.pack(padx=(30, 30), pady=(15, 15))
